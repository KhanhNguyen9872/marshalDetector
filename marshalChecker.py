if (__name__ == '__main__'):
	raise SyntaxError("this tool must import, not run as main file (using: import marshalChecker)")

print(">>>>>> Marshal Checker <<<<<<")
err = []
push = err.append
...
try:
	if not (list(obj.__dict__) == allAttr):
		push("marshal: __dict__ abnormal")
except Exception as e:
	push("marshal: __dict__ not found")
...
try:
	...
	push("marshal.loads: cannot test function! skipped!")
